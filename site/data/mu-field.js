...
window.DATA.matchups["lucy"] = {
  ...
  dibattiti: [],
  gameplan: {
    early: "Gioca i personaggi da 1 e 2 costi per costruire una board ampia. Mulligan per <strong>1C Luffy</strong>, <strong>2C Bon Clay</strong>, <strong>2C Daz Bones</strong>. Se l'avversario non sviluppa personaggi piccoli in early, i tuoi weenies restati assorbono in sicurezza gli attacchi del loro leader.",
    mid: "Transiziona nel package <strong>5C Buggy + 6C Prisoner of Impel Down</strong>, poi <strong>7C Boa</strong> per mantenere la pressione. Spamma attacchi da 6k sul leader: se gli manca la Stage, faticano a proteggersi perché il mazzo esaurisce in fretta i 2k counter. Freeza <strong>7C Sabo</strong> e <strong>4C Cavendish</strong> con <strong>7C Boa</strong> e <strong>4C Galdino</strong> mentre continui ad attaccare wide.",
    late: "Usa i freeze event per bloccare la loro board. Se li hai portati a 0 vite presto, calcola ogni difesa contro un potenziale turno <strong>10C Roger</strong> e gioca difensivo per non perdere di colpo; se serve, tienili a 1 vita e riduci prima le carte in mano attaccando la loro board."
  },
  leaderText: "Lucy (Dressrosa / Armata Rivoluzionaria) — 5000 power, 4 vite, Rosso/Blu. «[Quando attacca / Quando l'avversario attacca] Puoi scartare un qualsiasi numero di carte Evento o Stage dalla tua mano: questo Leader guadagna +1000 power durante questa battaglia per ogni carta scartata. [Activate:Main / Una volta per turno] Se durante questo turno hai attivato una carta Evento con costo base 3 o più, pesca 1 carta.»",
  carteAvversarie: [
  ...
  perFonte: [
    {
      ...
      sezioni: [
        { titolo: "Verdetto e turn order", html: "<p><strong>Favorability: Favored.</strong> Turn order: <strong>vai secondo</strong>. Andare secondi disturba la loro curva preferita di concatenare <strong>4C Cavendish</strong> o <strong>4C Bartolomeo</strong> consecutivi in <strong>7C Sabo</strong>, e gli nega la pescata del primo turno, rendendo più facile metterli sotto pressione sulle risorse in early.</p>" },
        { titolo: "Mulligan", html: "<p>Priorità: <strong>1C Luffy</strong>, <strong>2C Bon Clay</strong>, <strong>2C Daz Bones</strong>.</p>" },
        { titolo: "Macro gameplan", html: "<p>Esegui la strategia wide standard schierando due o più personaggi per turno. Attacca frequentemente a soglia 6k o superiore: <strong>Red Blue Lucy</strong> può faticare a difendersi dalla pressione continua a 6k. Nel late game usa i freeze event per bloccare la loro board, tenendo conto di un potenziale <strong>10C Roger</strong> per non perdere il vantaggio.</p>" },
...
window.DATA.matchups["rbace"] = {
  ...
  dibattiti: [],
  gameplan: {
    early: "Curve out con i personaggi da 2 costi. Mulligan per <strong>1C Luffy</strong>, <strong>2C Bon Clay</strong>, <strong>2C Daz Bones</strong>, oppure il package <strong>5C Buggy + 6C Prisoner of Impel Down</strong>. Con una mano aggro early e lo spam di 6k gli eroderai la mano rapidamente.",
    mid: "Prosegui la curva in <strong>5C Buggy + 6C Prisoner of Impel Down</strong>, poi <strong>7C Boa</strong>. Sfrutta i turni in cui non hanno DON!! attaccati al leader: saranno costretti a counterare più attacchi, altrimenti perdono la pescata dell'abilità leader.",
    late: "Chiudi con <strong>7C Boa + 6C Brook</strong>. Se <strong>7C Boa</strong> viene disabilitata (loro <strong>6C Boa</strong> e <strong>4C Galdino</strong>), pivota: <strong>2C Galdino</strong> + attaccanti 6k + il board restand event, oppure setup di <strong>2C Bon Clay</strong> che attacca due volte con <strong>6C Brook</strong> come win condition."
  },
  leaderText: "Portgas.D.Ace (Pirati di Barbabianca) — 6000 power, 3 vite, Rosso/Blu. «[Quando l'avversario attacca / Una volta per turno] Puoi scartare 1 carta dalla tua mano: fino a 1 Leader o Personaggio avversario riceve -2000 power durante questa battaglia. [DON!! x1 / Una volta per turno] Quando ricevi danno o un tuo Personaggio con power base 6000 o più viene messo K.O., pesca 1 carta.»",
  carteAvversarie: [
