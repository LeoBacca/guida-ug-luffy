...
window.DATA.tech = [
  ...
  { key: "jinbe", nome: "Jinbe (2c 2k)", domanda: "Serve il 2k counter extra con corpo?",
    verdetti: [
      ...
      { fonte: "equinby", verdetto: "out", testo: "«Jinbe proprio non mi piace. Vorrei che quei Jinbe fossero Galdino»: non si rimpiazza e non fa nulla di rilevante per il costo che ha" },
    ...
    trend: "Le guide (prima) lo giocano ×2; le voci dal campo (dopo) lo tagliano all'unanimità — il flip-flop più netto del pool" },
