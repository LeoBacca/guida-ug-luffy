...
window.DATA.matchups["rosinante"] = {
  ...
  consenso: [
    ...
    { testo: "<strong>Freeza i blocker con Boa Hancock e Galdino (Mr.3).</strong> Dog: baita <strong>Rosinante & Law (6c)</strong> a bloccare, poi freezalo con un altro Blocker per più turni. Dog coaching: Boa qui serve soprattutto a negare il blocker, non il Leader. Raphterra: stalla gli 8k con Galdino/Boa e nel late combina i freeze event per bloccare 3+ attaccanti.", fonti: ["dog", "dogcoach", "raphterra"] },
  ...
  gameplan: {
    early: "<p>Vai largo presto e leggi il <em>loro</em> start: se partono con 2k bodies + curva <strong>Law (4c)</strong> è più dura (tradeggiano i piccoli), se partono lenti o senza 2k bodies vai <strong>aggro</strong> — non riescono a tradeggiare e sprecano il Leader swing sui piccoli. Sviluppa corpi da 6k (resilienti) ma occhio a <strong>Gum-Gum Lightning</strong> e <strong>Sakazuki</strong>. Se la tua mano è buona, counter gli attacchi early che chiedono una sola carta: preservi i life per lo standoff e resti sotto la soglia delle 7 carte di <strong>Law (4c)</strong> (Raphterra). Linea top di Dog: <strong>Buggy + Prisoner a 5 DON!!</strong>, poi Hancock e Mr.3.</p>",
    mid: "<p>Per Dog è <strong>la parte più importante</strong> del matchup. Rosinante è prevedibile: vuole <strong>Rosinante & Law (6c)</strong> appena arriva a 5 DON!!. Baitalo a bloccare, poi freezalo insieme a un altro Blocker per più turni. Sequenza top: <strong>Boa Hancock</strong> (nega un Blocker), forzi un altro block, poi <strong>I Know You're Strong…</strong> o <strong>Electrical Luna</strong> → un turno intero senza i loro Blocker. Raphterra: non lasciare corpi rested con leggerezza (li clearano con gli 8k, <strong>Sakazuki (7c)</strong> e <strong>Gum-Gum Lightning</strong>); attacca con Leader e corpi sacrificabili, usa il loop di <strong>Crocodile</strong> per rigiocare i 2-cost stanti. Dog coaching: swinga 5-5 invece di 8 e attacca i loro rested ≤6k per forzare decisioni.</p>",
    late: "<p><strong>Hand reading</strong>: conta i counter che possono avere, guarda la card advantage più dei life (double heal, o heal + DON!! aperto per <strong>I Love You</strong>). Con un <strong>Sakazuki</strong> early cheatano DON!! → double <strong>Borsalino</strong> con un DON!! aperto. Dal turno dei 9/10 DON!!: poke col Leader e i sacrificabili, poi reagisci — se tengono i blocker attivi sviluppa e passa con la board attiva; se usano i blocker, attacca con tutto e chiudi col restand o freeza tutto e chiudi il turno dopo (Raphterra). <strong>Gravity Blade</strong> il turno prima del push (due <strong>Rosinante & Law</strong> a fondo mazzo). <strong>Brook (8c per Dog)</strong> e <strong>DMG</strong> gestiscono doppio Blocker o Blocker + DON!! aperto. Resta a 2-3 life.</p>"
  },
  ...
  perFonte: [
    {
      ...
      sezioni: [
        { t: "Overview",
          c: "<p><strong>Difficoltà: Even · Start preferito: Primo.</strong> Uno dei migliori deck del format. Si basa su <strong>resource management</strong> e quantità di pressione. <strong>Non puoi vincere la guerra di board control</strong> contro Rosinante → pressali e forzali a spendere risorse. Rosinante genera molte risorse ma può brickare. Andando primo: più pressione, loro più lenti.</p><p>Punto chiave: se non partono con diversi <strong>2k bodies</strong> o <strong>searcher</strong>, il loro gioco si complica → puniscili. Rispetta <strong>Borsalino (5c)</strong> e l'Event da 1 <strong>I Love You</strong>: tool difensivi economici che bloccano molti swing da 6k. Win condition: setup di <strong>Let's Go!! to the Navy Headquarters</strong> (non hanno molti modi di interagire con la board stante).</p><p>Mulligan: vedi lo screenshot «mulligan PY Rosinante» nel capitolo sorgente.</p>" },
        { t: "Early game",
          c: "<p>Vai largo presto. Dipende molto dal <em>loro</em> start: se partono con 2k bodies + curva <strong>Law (4c)</strong> è più difficile (tradeggiano meglio i piccoli); se partono lenti, è più facile. Se non vedono 2k bodies, <strong>aggro</strong>: non riescono a tradeggiare efficacemente e spesso devono spendere il Leader swing sui piccoli.</p><p>Sviluppa <strong>corpi da 6k</strong> (resilienti), ma occhio a <strong>Gum-Gum Lightning</strong> e <strong>Sakazuki</strong> (spengono quasi ogni personaggio). Swing larghi: forza più carte possibili dalla loro mano. Spesso la linea top è <strong>Buggy + Prisoner a 5 DON!!</strong>, poi <strong>Boa Hancock</strong> (nega un Blocker) e <strong>Mr.3</strong> (impedisce trade efficienti nei tuoi 6k).</p>" },
        { t: "Mid game",
          c: "<p><strong>La parte più importante del matchup.</strong> Rosinante è prevedibile: vuole <strong>Rosinante & Law (6c)</strong> appena arriva a 5 DON!!. Gioca quasi come glass cannon ma ristabilisci sempre una board resiliente: Rosinante soffre la pressione costante con swing multipli mentre sviluppi nuovi corpi.</p><p>Baita carte come <strong>Rosinante & Law</strong> a bloccare, poi freezalo insieme a un altro Blocker per più turni. Sequenza top: <strong>Boa Hancock</strong> (nega un Blocker), forzi un altro block, poi <strong>I Know You're Strong…</strong> o <strong>Electrical Luna</strong> → un turno senza i loro Blocker. Questi freeze possono spostare il vantaggio; se PY Rosinante sale di rappresentazione, diventano staple.</p>" },
        { t: "Late game",
          c: "<p>Capire quanti <strong>counter</strong> possono avere in mano: l'<strong>hand reading</strong> è importante. Guarda la loro <strong>card advantage</strong> più dei life (hanno <strong>double heal</strong>, o double heal + un DON!! aperto). Con un <strong>Sakazuki</strong> early cheatano DON!! → double <strong>Borsalino</strong> con un DON!! aperto per <strong>I Love You</strong>.</p><p>Rimuovi più carte possibili dalla loro mano, poi costruisci la board per <strong>Let's Go!! to the Navy Headquarters</strong>. I freeze danno un turno extra. <strong>Brook (8c)</strong> è utile se restano con un solo DON!! aperto per I Love You. Anche <strong>DMG</strong> aiuta (gestisce doppio Blocker o Blocker + DON!! aperto). Sii conservativo coi life: resta intorno a <strong>2-3 life</strong>.</p>" },
        { t: "Tips",
          c: "<ul><li>Non provare a vincere la guerra di board control: pressa e svuota la loro mano.</li><li>Pressione larga ma swing significativi (6k+ se hanno Blocker da 6k).</li><li>Punisci se mancano 2k bodies / searcher / <strong>Law (4c)</strong>.</li><li><strong>Boa Hancock</strong>, <strong>Mr.3</strong> e i freeze (<strong>I Know You're Strong…</strong> / <strong>Electrical Luna</strong>) per negare i Blocker.</li><li>Focus sulla hand size più che sui life (recuperano molto).</li><li><strong>Let's Go!! to the Navy Headquarters</strong> come finisher.</li></ul>" }
      ]
    },
    {
      fonte: "raphterra",
...
window.DATA.matchups["yamato"] = {
  ...
  gameplan: {
    early: "<p>Early semplice: pochi loro personaggi nei primi turni, curva prevedibile (Kurikomon → 6k bodies). <strong>Counter i primi attacchi da 5k/6k che chiedono una sola carta</strong> e sviluppa restando healthy. Attento se partono con 1-cost (tradeggiano Mr.1, Mr.2 Bon Clay, Luffy da 5): sviluppa corpi più grandi o proteggi i piccoli col loop di <strong>Crocodile</strong>. Se loro non hanno weenie early, i tuoi piccoli funzionano da pseudo-blocker (Raphterra). Chiudi l'early con <strong>Buggy + Prisoner</strong> o Crocodile + più corpi. Nota: spesso meglio 5k + 7k che due 6k (tanti 2k counter dal loro lato).</p>",
    mid: "<p>Una delle fasi più importanti. Non rallenti molto la loro aggressione, ma <strong>Boa Hancock + Mr.3</strong> danno tempo — stunna le copie di <strong>Yamato (8c)</strong> (Raphterra). <strong>Electrical Luna</strong> e <strong>I Know You're Strong…</strong> sono quasi inutili qui (board fatta di 8k+). Nessuno dei due interagisce con la board dell'altro → entrambi al Leader: gestisci <strong>life e hand size</strong>. Se attaccano i tuoi 6k rested, di solito va bene: hanno già dato valore. Chiudi il mid con almeno una <strong>Hancock</strong> in board che nega uno dei loro 6k swing. Prima dei free block, conta sempre quanti attacchi gli restano (occhio a Yamato 8k + <strong>Otama</strong> sul tuo blocker).</p>",
    late: "<p>Relativamente facile se hai navigato bene. Skill chiave: leggere la <strong>counter power</strong> di entrambi. Occhio alla combo 8k bodies + Yamato che ri-porta il <strong>Blocker da 2</strong> (punisce con 5k/6k/8k), agli Event difensivi +3k/+4k e a <strong>Ground Death</strong> (spegne un tuo Blocker → non affidarti a un solo corpo difensivo). Imposta il lethal: <strong>Let's Go!! to the Navy Headquarters</strong> è facile da abilitare (niente removal loro); alternative: doppi swing con Hancock, <strong>Brook</strong> (restand), <strong>DMG</strong> (spegne più Blocker insieme). Raphterra: sul lethal spesso devi scommettere — o speri che non abbiano i counter, o in difesa accetti che i tuoi life possano contenere counter, perché devi salvare i combo pieces in mano (<strong>Brook</strong> + restand event).</p>"
  },
  ...
  perFonte: [
    {
      ...
      sezioni: [
        { t: "Overview",
          c: "<p><strong>Difficoltà: Even · Start preferito: Secondo.</strong> Matchup dove entrambi vanno soprattutto al <strong>Leader</strong>. Capire quanta pressione Yamato può fare e rispettare la loro <strong>counter power</strong> (tanto draw, ciclano bene → molti 2k counter). Loro partono a <strong>5 life</strong>, noi a <strong>4</strong> → pressione su di noi. Non gestiamo bene i loro 6k → capire quanto tempo abbiamo.</p><p><strong>Resta healthy</strong> nell'early (counter gli attacchi che chiedono una sola carta). Board larga; a seconda dei loro 2k bodies decidi se andare wide coi piccoli o affidarti a <strong>Buggy + Prisoner</strong> / <strong>Crocodile</strong>. Mid/late: <strong>Boa Hancock + Mr.3</strong> negano i loro 6k swinger. <strong>Yamato non ha vera removal</strong> → l'unico modo di gestire la nostra board è attaccarla (e se attaccano un nostro 6k rested va bene: ha già dato valore e fa da pseudo-Blocker). Matchup basato sul <strong>clock setup</strong>.</p><p>Mulligan: vedi lo screenshot «mulligan B Yamato» nel capitolo sorgente.</p>" },
        { t: "Early game",
        ...
        { t: "Late game",
          c: "<p>Relativamente facile se hai navigato bene. Skill chiave: capire la <strong>counter power</strong> di entrambi. Entrambi hanno <strong>Blocker</strong> e pochi modi di gestirli → puoi fare doppio Blocker, ma anche loro. Combo loro pericolosa: 8k bodies + Yamato che ri-porta il <strong>Blocker da 2</strong> → punisce con 5k/6k/8k. Rispetta i loro Event difensivi (+3k/+4k). Attento a <strong>Ground Death</strong> (spegne un tuo Blocker) → non affidarti a un solo corpo difensivo.</p><p>Obiettivo: setup di lethal. Facile impostare <strong>Let's Go!! to the Navy Headquarters</strong> (Yamato non ha removal per la nostra board): con nomi diversi crei molti swing e chiudi. Partita da costruire <strong>lentamente</strong>: naviga ogni fase, guadagna risorse, resta healthy. Yamato è <strong>molto prevedibile</strong> → guarda la partita dal loro lato. Alternative al lethal: doppi swing con Hancock, o <strong>Brook</strong> (spegne i loro 6k swing). <strong>DMG</strong> utile (spegne più Blocker insieme).</p>" },
        { t: "Tips",
